...
@section('content')
    ...
    <section class="bg-gradient-to-br from-blue-800 via-indigo-900 to-blue-900 py-16 min-h-screen">
        <div class="container mx-auto px-4">
            <h2 class="text-4xl font-bold text-white text-center mb-12" data-aos="fade-down">Meet Our Faculty</h2>
            ...
            <!-- Pagination -->
            <div class="mt-10 flex justify-center text-white" data-aos="fade-up">
                {{ $team->links() }}
            </div>
        </div>
    </section>
