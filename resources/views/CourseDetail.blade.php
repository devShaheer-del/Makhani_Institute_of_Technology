...
@section('title', $course->title . ' | Makhani Institute of Technology')
@section('meta_keywords', $course->title . ', IT Courses in Pakistan, Learn ' . $course->title . ', Makhani Institute, Best Tech Institute')
@section('meta_description', $course->short_description ?? 'Learn ' . $course->title . ' at Makhani Institute of Technology. Master essential skills from experts and launch your tech career.')
...
<section class="bg-gradient-to-br from-blue-800 via-indigo-800 to-blue-900 text-white min-h-screen py-20">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <!-- What You Will Learn -->
        @if (!empty($course->modules) && count($course->modules))
            <div class="mb-12">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div class="bg-white/10 p-6 rounded-2xl border border-white/10">
                ...
                <ul class="text-white/80 space-y-2 text-base">
                    <li><strong>Total Classes:</strong> {{ $course->total_classes ?? 'N/A' }}</li>
                    <li><strong>Duration:</strong> {{ $course->duration ?? 'N/A' }}</li>
                    <li><strong>Course Fee:</strong> {{ $course->fee ?? 'Contact for Details' }}</li>
        ...
        <div class="mt-12 text-center">
            <img src="{{ $course->banner ?? asset('/images/default-banner.jpg') }}"
