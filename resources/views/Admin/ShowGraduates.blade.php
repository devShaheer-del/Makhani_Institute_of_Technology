            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-indigo-600 to-cyan-600 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Father's Name</th>
                        <th class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Course</th>
                        <th class="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Graduation Date</th>
                ...
                <tbody class="divide-y divide-gray-100 text-gray-700">
                    @foreach($graduates as $index => $graduate)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ \Carbon\Carbon::parse($graduate->graduation_date)->format('M d, Y') }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $graduate->grade }}</td>
                            <td class="px-6 py-4 whitespace-nowrap space-x-2">
                                
                                <a href="{{ url('DeleteGraduates/'.$graduate->id) }}" class="text-red-600 hover:text-red-800 font-medium">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
