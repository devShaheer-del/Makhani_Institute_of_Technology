...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-400 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl w-full bg-white shadow-xl rounded-2xl p-10 space-y-6" data-aos="zoom-in">
        ...
        <form action="EnrollStudent" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Submit Button -->
            <div class="col-span-1 md:col-span-2" data-aos="fade-up" data-aos-delay="{{ $delay += 100 }}">
                <button type="submit"
