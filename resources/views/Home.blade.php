    ...
    <section class="bg-white py-20">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <!-- CIT -->
                <div
                    class="bg-gradient-to-br from-blue-600 to-blue-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300">
                    <div class="mb-4">
                ...
                <!-- Graphic Designing -->
                <div
                    class="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300">
                    <div class="mb-4">
                        <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                ...
                <!-- Web Development -->
                <div
                    class="bg-gradient-to-br from-cyan-600 to-blue-700 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300">
                    <div class="mb-4">
                        <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                ...
                <div
                    class="bg-gradient-to-br from-sky-600 to-blue-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300">
                    <div class="mb-4">
                        <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
    ...
    <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-20">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Overview of students who completed
                    various technical courses.</p>
            </div>
            <div class="flex flex-wrap -m-4">
                ...
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-blue-500 flex flex-col relative overflow-hidden">
                        ...
                        <h1 class="text-5xl text-gray-900 leading-none pb-4 mb-4 border-b border-gray-200">300</h1>
                        <p class="text-gray-600 mb-6">Students successfully passed the Computer Information Technology
                            course.</p>
                ...
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden">
                        ...
                        <h1 class="text-5xl text-gray-900 leading-none pb-4 mb-4 border-b border-gray-200">100</h1>
                ...
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-purple-500 flex flex-col relative overflow-hidden">
                        ...
                        <h1 class="text-5xl text-gray-900 leading-none pb-4 mb-4 border-b border-gray-200">150</h1>
                        <p class="text-gray-600 mb-6">Alumni from the web dev bootcamp track.</p>
