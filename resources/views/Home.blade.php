...
<section class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-6 text-center" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- CIT -->
            <div class="bg-gradient-to-br from-blue-600 to-blue-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300" data-aos="zoom-in" data-aos-delay="100">
                <div class="mb-4">
                ...
                <p class="text-sm opacity-90">Computer Information Technology fundamentals for beginners and professionals.</p>
            </div>

            <!-- Graphic Designing -->
            <div class="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300" data-aos="zoom-in" data-aos-delay="200">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                ...
                <p class="text-sm opacity-90">Master tools like Photoshop, Illustrator, and Figma to create stunning designs.</p>
            </div>

            <!-- Web Development -->
            <div class="bg-gradient-to-br from-cyan-600 to-blue-700 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300" data-aos="zoom-in" data-aos-delay="300">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
                ...
                <p class="text-sm opacity-90">Learn HTML, CSS, JavaScript, and modern frameworks to build responsive websites.</p>
            </div>

            <!-- Mobile App Development -->
            <div class="bg-gradient-to-br from-sky-600 to-blue-800 text-white p-8 rounded-2xl shadow-lg hover:scale-105 transition duration-300" data-aos="zoom-in" data-aos-delay="400">
                <div class="mb-4">
                    <svg class="w-12 h-12 mx-auto" fill="none" stroke="currentColor" stroke-width="2"
                        viewBox="0 0 24 24">
        ...
        <div class="flex flex-wrap -m-4">
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="100">
                <div class="h-full p-6 rounded-lg border-2 border-blue-500 flex flex-col relative overflow-hidden">
                    ...
                    <button class="mt-auto text-white bg-blue-500 hover:bg-blue-600 py-2 px-4 rounded">View Details</button>
                </div>
            </div>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="200">
                <div class="h-full p-6 rounded-lg border-2 border-green-500 flex flex-col relative overflow-hidden">
                    ...
                    <button class="mt-auto text-white bg-green-500 hover:bg-green-600 py-2 px-4 rounded">View Details</button>
                </div>
            </div>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="300">
                <div class="h-full p-6 rounded-lg border-2 border-purple-500 flex flex-col relative overflow-hidden">
                    <h2 class="text-sm tracking-widest title-font mb-1 font-medium text-purple-500">Web Development</h2>
                    <h1 class="text-5xl text-gray-900 leading-none pb-4 mb-4 border-b border-gray-200">
                        {{ $courseCounts['Web Development'] ?? 0 }}
                    </h1>
                    <p class="text-gray-600 mb-6">Alumni from the Web Development bootcamp.</p>
                    <button class="mt-auto text-white bg-purple-500 hover:bg-purple-600 py-2 px-4 rounded">View Details</button>
                </div>
            </div>
            ...
            <div class="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos="fade-up" data-aos-delay="400">
                <div class="h-full p-6 rounded-lg border-2 border-yellow-500 flex flex-col relative overflow-hidden">
                    <h2 class="text-sm tracking-widest title-font mb-1 font-medium text-yellow-500">Mobile App Development</h2>
                    <h1 class="text-5xl text-gray-900 leading-none pb-4 mb-4 border-b border-gray-200">
                        {{ $courseCounts['Mobile App Development'] ?? 0 }}
                    </h1>
                    <p class="text-gray-600 mb-6">Students trained under mobile app mentorship programs.</p>
                    <button class="mt-auto text-white bg-yellow-500 hover:bg-yellow-600 py-2 px-4 rounded">View Details</button>
                </div>
            </div>
        </div>
    </div>
