...
@section('content')
  ...
  <section class="bg-gradient-to-br from-blue-700 via-indigo-700 to-blue-900 text-white py-24">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
            ...
            <p class="text-white/90 text-lg mb-4">
                Makhani Institute of Technology is more than just a place to learn—it's a place to innovate, explore, and grow. 
                With state-of-the-art labs, industry-focused curriculum, and mentorship from tech experts, we prepare students 
                to lead the future of technology.
            </p>
            <p class="text-white/70 mb-6">
                Our mission is to close the gap between education and industry by delivering hands-on, real-world learning experiences.
                We believe in empowering our students through practical knowledge, creativity, and collaboration.
            </p>
            <a href="#programs" class="inline-block bg-white text-blue-800 font-semibold px-6 py-3 rounded-full hover:bg-cyan-200 transition">
                Discover Our Programs
            </a>
        </div>

        <!-- Right Feature Box -->
        <div class="bg-white/10 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-white/20">
  ...
  <div class="max-w-6xl mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-10">
      ...
      <div class="bg-blue-50 p-6 rounded-2xl shadow">
        ...
        <p class="text-gray-600">We uphold honesty, responsibility, and ethics in all interactions and decisions.</p>
      </div>
      <div class="bg-blue-50 p-6 rounded-2xl shadow">
...
<section class="bg-gradient-to-br from-indigo-800 via-blue-900 to-indigo-900 text-white py-20">
  <div class="max-w-6xl mx-auto px-6 text-center">
    <h2 class="text-3xl font-bold mb-4">Meet Our Mentors</h2>
    <p class="text-white/80 mb-10 text-lg">Driven by experience, inspired by innovation — our leaders shape futures.</p>
    <div class="grid md:grid-cols-3 gap-10">
      <div class="bg-white/10 p-6 rounded-2xl shadow backdrop-blur-md border border-white/10">
...
<section class="bg-blue-50 py-20">
  <div class="max-w-6xl mx-auto px-6 text-center">
    <h2 class="text-3xl font-bold text-indigo-700 mb-6">What Our Students Say</h2>
    <div class="grid md:grid-cols-2 gap-10 text-left">
      <div class="bg-white p-6 rounded-2xl shadow-md border">
        <p class="text-gray-700 italic">"The instructors at MIT are amazing. Their teaching style and mentorship truly transformed my career."</p>
        <p class="mt-4 font-semibold text-blue-800">— Ayesha J., Web Development Graduate</p>
      </div>
      <div class="bg-white p-6 rounded-2xl shadow-md border">
        <p class="text-gray-700 italic">"I gained real-world skills through hands-on projects. This institute gave me the confidence to launch my own startup."</p>
