...
@section('title', 'About Us | Makhani Institute of Technology - Shaping Tech Leaders')

@section('meta_keywords', 'About Makhani Institute, Best IT institute in Pakistan, tech training, web development institute, graphic designing institute, mobile app courses, CIT program, tech mentorship Pakistan')

@section('meta_description', 'Discover the vision, mission, and mentorship behind Makhani Institute of Technology – Pakistan’s premier IT institute dedicated to empowering future tech leaders with real-world skills and innovation-driven education.')
    ...
    <div class="max-w-6xl mx-auto px-6 text-center">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            <div class="bg-white/10 p-6 rounded-2xl shadow backdrop-blur-md border border-white/10" data-aos="fade-up"
                data-aos-delay="100">
                <h3 class="text-xl font-semibold text-cyan-200">Sir Ameer Makahani</h3>
                <p class="text-white/80">CEO and Founder</p>
            </div>
            <div class="bg-white/10 p-6 rounded-2xl shadow backdrop-blur-md border border-white/10" data-aos="fade-up"
                data-aos-delay="200">
                <h3 class="text-xl font-semibold text-cyan-200">Sir Naveed Chagani</h3>
                <p class="text-white/80">Gernal Sectory</p>
            </div>
            <div class="bg-white/10 p-6 rounded-2xl shadow backdrop-blur-md border border-white/10" data-aos="fade-up"
                data-aos-delay="300">
                <h3 class="text-xl font-semibold text-cyan-200">Miss Sahar Inam</h3>
                <p class="text-white/80">Head of Tech Department</p>
            </div>
        </div>
    </div>
</section>
